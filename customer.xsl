                ...
                <table style="border-collapse: collapse; width:100%; overflow: hidden; border-radius: 15px;     box-shadow: 2px 2px 8px 2px #4a4a4a4d;">
                    ...
                    <xsl:for-each select="customers/person">
                        <tr style=" font-size:18px; color:#3e3e3e;">
                           <td style="    border-bottom: solid #e5e5e5 1px;"><xsl:value-of select="Fname"/></td>
                            <td style="    border-bottom: solid #e5e5e5 1px;"><xsl:value-of select="Lname"/></td>
                            <td style="    border-bottom: solid #e5e5e5 1px;"><xsl:value-of select="birthday"/></td>
